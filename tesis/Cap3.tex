...
\textcolor{red}{Por su parte, el análisis de las comunidades en la red insumo-producto mundial ofrece una oportunidad para evaluar el nivel de integración económica del ASEAN a partir de sus vínculos interindustriales. En primer lugar, los resultados indican un fuerte nivel de estabilidad en la integración económica de la región, en el sentido de que la economía la mayoría de países miembros pertenecen al mismo bloque económico durante el periodo estudiado.\footnote{Véase las filas VNM, KHM, MYS, PHL, SGP, THA, LAO, IND, BRN y MMR de  la figura \ref{ComunidadesPorPais}.} 
En segundo lugar, en análisis de comunidades permitió identificar a los países que con menor cohesión en la economía regional de la ASEAN, a partir del número de años en los que sus economías conforman una comunidad individual: Indonesia (14 años), Myanmar (13 años),  Brunei (6 años) y Filipinas (4 años). En contraste, también se observaron vínculos de integración con economías externas al ASEAN, particularmente Taiwán y Hong Kong. El Caso de Taiwán resulta relevante, ya que durante todo el periodo estudiado formó parte del bloque económico asociado a la mayoría de países del ASEAN. Finalmente, los resultados no muestran una asociación directa con el establecimiento de acuerdos de libre comercio formales. Por ejemplo, aunque el ASEAN ha formalizado áreas de libre comercio con países como Japón, China o India, esto no se ve reflejado en la integración de sus economías en la misma comunidad. Mientras que, en el caso de Hong Kong, su integración al bloque económico asociado a la ASEAN ocurre años antes del establecimiento de un acuerdo oficial. Por el contrario, aunque el ASEAN no cuenta con un tratado de libre comercio con Taiwán, su economía se encuentra estrechamente vinculada a la de los países del ASEAN a través de sus vínculos interindustriales.}
...
\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{sankey_diagrams/asean_3.png}
