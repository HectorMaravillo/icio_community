...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{subgraphs/asean_subgraph.png}
	\caption{Subgráfica inducida por los vértices de los páises de la \gls{asean}, Taiwan y Hong Kong (2022).$^{*}$}
	\label{Subgraph_ASEAN}
...
Por último, la figura \ref{Subgraph_ASEAN} presenta la subgráfica inducida por los países de la \gls{asean}, Taiwán y Hong Kong, independientemente de la comunidad a la que pertenezca cada vértice. El tamaño de cada vértice depende de su fuerza de salida; su color, del país al que pertenece; y su distribución espacial, de la aplicación del algoritmo de Fruchterman--Reingold (véase el anexo \ref{anexo5}). Únicamente se muestra el 5\% de las aristas con mayor peso de la región. Las transacciones domésticas se representan en gris y las internacionales, en coral. La figura muestra la existencia de fuertes vínculos intersectoriales en la región, principalmente entre Indonesia, Taiwán, Vietnam, Tailandia, Filipinas, Singapur y Malasia. A estos les siguen Hong Kong, Camboya y Laos y, en último lugar, Brunéi. Además, los flujos comerciales intrarregionales más intensos parecen mantener un equilibrio con los flujos comerciales internos.
