...
\begin{itemize}
    ...
    \item Construir una serie de redes insumo--producto internacionales anuales a partir de la base de datos  \acrshort{icio}--\gls{ocde}.
    ...
    \item Analizar la composición y evolución de las comunidades identificadas como aproximación a la interdependencia productiva y los procesos de integración regional.
\end{itemize}

\section{Hipótesis}

La representación de las relaciones insumo--producto internacionales mediante redes, junto con la aplicación de métodos de detección de comunidades, permite identificar bloques productivos a partir de la intensidad efectiva de los flujos intersectoriales. La composición de estos bloques productivos o comunidades tiene como base a las economías nacionales y sus agrupaciones regionales. Además, el análisis de la evolución de estas comunidades ofrece una aproximación empírica a los cambios en la interdependencia productiva entre los países y permite evaluar su correspondencia con los procesos formales de integración comercial.